...
<div class="wrap">
    ...
    $menuItems = [
        ...
        ['label' => 'Glosar Teoretic', 'url' => ['/site/glosar']],
    ...
    if (Yii::$app->user->isGuest) {
        ...
        $menuItems[] = ['label' => 'Tests', 'url' => ['/site/tests']];
        $menuItems[] = ['label' => Html::img('/images/profilePicture/'. Yii::$app->user->identity->photoName , ['width'=>'50', 'height'=>'50'])];
